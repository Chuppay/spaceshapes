...
public abstract class Shape {
	 ...
	 * is called on. If the callee object is not a child within a CarrierShape
	...
	public void setParent(CarrierShape parentShape){
		_parent = parentShape;
	}
	...
	public List<Shape> path(){
		...
		if (_parent==null){
			...
			CarrierShape tempShape = _parent;
			while (tempShape!= null){
				path.add(tempShape);
				tempShape=tempShape.parent();
			}
	...
	/**
	 * Allows user to add text to the shape
	 */
